...
import (
	...
	"github.com/IgorRAzumov/go-link-shorter/internal/domain/service/health_check"
	...
	healthcheckusecase "github.com/IgorRAzumov/go-link-shorter/internal/domain/usecase/health_check"
...
func Run(serverAddress, baseURL, fileStoragePath, databaseDSN string) {
	...
	healthCheckService := health_check.NewHealthCheckService(dataBaseStorage)
